...
class Args:
    ...
    policy_path: str = "/root/autodl-tmp/outputs/pi0_training/checkpoints/003000/pretrained_model"
    ...
    video_out_path: str = "/root/autodl-tmp/lerobot/outputs/eval/test"
    """Path to save videos."""
    device: str = "cuda"
            ...
            while t < max_steps:
                try:
                    ...
                    observation = {
                        ...
                        #"observation.joint_state": torch.from_numpy(obs["robot0_joint_pos"]).to(torch.float32).to(args.device).unsqueeze(0),
                        # "task": [task_description + "\n"],
                        "observation.language.tokens": lang["input_ids"].to(args.device),
                        "observation.language.attention_mask": lang["attention_mask"].to(args.device),
                    }
